...
import (
	...
	"github.com/gzjjjfree/gzv2ray/features"
	"github.com/gzjjjfree/gzv2ray/features/dns"
	"github.com/gzjjjfree/gzv2ray/features/dns/localdns"
	"github.com/gzjjjfree/gzv2ray/features/inbound"
	"github.com/gzjjjfree/gzv2ray/features/outbound"
	"github.com/gzjjjfree/gzv2ray/features/policy"
	"github.com/gzjjjfree/gzv2ray/features/routing"
	"github.com/gzjjjfree/gzv2ray/features/stats"
)
...
func initInstanceWithConfig(config *Config, server *Instance) (bool, error) {
	...
	if err := config.Transport.Apply(); err != nil { // Transport 已弃用，
		return true, err
	}
